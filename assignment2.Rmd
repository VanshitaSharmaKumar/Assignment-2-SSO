...
# Excercise 2.5
### 2.5a
```{r, fig.cap=c('2.5a Shift scheduling'), out.width='50%', fig.show='hold', fig.align='center', fig.pos='H', echo=FALSE}
...
### 2.5b
```{r, fig.cap=c('2.5b Shift scheduling'), out.width='50%', fig.show='hold', fig.align='center', fig.pos='H', echo=FALSE}
