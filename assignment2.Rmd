...
The schedule is optimized to minimize the absolute sum of differences between scheduled hours en demanded hours. This is done by adding $d+$ and $d-$ to make the non-linear relation linear again.