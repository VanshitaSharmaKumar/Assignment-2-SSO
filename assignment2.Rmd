...
It is important to note that for all questions (including 2.4 and 2.5), the options menu has the same configuration as in the image below. 
```{r, fig.cap=c('Options Menu'), out.width='55%', fig.show='hold', fig.align='center', fig.pos='H', echo=FALSE}
...
\end{aligned}
\]
```{r, fig.cap=c('2.3a Excel Solver'), out.width='65%', fig.show='hold', fig.align='center', fig.pos='H', echo=FALSE}
...
```{r, fig.cap=c('2.3b Excel Solver'), out.width='65%', fig.show='hold', fig.align='center', fig.pos='H', echo=FALSE}
...
\]
```{r, fig.cap=c('2.3c Excel Solver'), out.width='65%', fig.show='hold', fig.align='center', fig.pos='H', echo=FALSE}
...
```{r, fig.cap=c('2.4a Excel Solver'), out.width='65%', fig.show='hold', fig.align='center', fig.pos='H', echo=FALSE}
...
```{r, fig.cap=c('2.4b Excel Solver'), out.width='65%', fig.show='hold', fig.align='center', fig.pos='H', echo=FALSE}
...
# Excercise 2.5
### 2.5a
```{r, fig.cap=c('2.5a Shift scheduling'), out.width='65%', fig.show='hold', fig.align='center', fig.pos='H', echo=FALSE}
knitr::include_graphics(c('imgs/2_5a.png'))
```
...
### 2.5b
```{r, fig.cap=c('2.5b Shift scheduling'), out.width='65%', fig.show='hold', fig.align='center', fig.pos='H', echo=FALSE}
knitr::include_graphics(c('imgs/2_5b.png'))
```

The schedule is optimized to minimize the absolute sum of differences between scheduled hours en demanded hours. This is done by adding $d+$ and $d-$ to make the non-linear relation linear again. In the end, the biggest difference occurs when there are either 3 more or 3 less people scheduled than demanded. The sum of differences is 17.